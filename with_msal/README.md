...
To use the `voila-with_msal` template, pass option `--template=with_msal` to the `voila` command line.


## Development/contributing
The actual template files can be found in `share/jupyter/voila/templates/with_msal/nbconvert_templates/`.
